...
$tabs_titles = array(
    ...
    ?>
<section class="wrap container py-5">
</section>

<section id="tab-options" class="container">
    <nav>
        <div class="nav nav-tabs py-6" id="nav-tab" role="tablist">
            <?php $first = 0; ?>
            <?php foreach ($tabs_titles as $tab) { ?>
                <?php $tab['first'] = $first ?>
